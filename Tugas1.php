...
<div class="container-fluid">
  ...
  <a href="#" class="list-group-item list-group-item-action">TV 4.2000.000</a>
  ...
  <a class="list-group-item list-group-item-action active" aria-current="true">Harga dapat berubah setiap saat</a>
</div>
		</div>
	</div>
</div>
